<?php
$base_path = '../../../../';
$page_title = "SEO Agency in Ghazipur — rankfyno Local SEO";
...
$footer_brand_desc = "Local SEO engineered for Uttar Pradesh businesses. We rank Ghazipur companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.";
  ...
  <header class="hero">
    <div class="container hero-inner">
      <div class="hero-image-wrap">
        <picture>
          <picture><source srcset="../images/hero.webp" type="image/webp"><img src="../images/hero.jpg" alt="Best SEO Company in Ghazipur — rankfyno organic growth trophy" class="hero-image" loading="eager" width="1280" height="720" />/></picture>
        </picture>
      </div>
