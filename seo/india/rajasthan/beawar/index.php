...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Agency in Beawar — rankfyno Local SEO</title>
  <meta name="description" content="rankfyno is a local SEO agency in Beawar. We engineer GBP, citation, on-page and content SEO for Beawar businesses — textile processing · marble & granite mining · cement manufacture · mineral logistics. Real rankings. Real leads." />
  ...
  <header class="hero">
    <div class="container hero-inner">
      <div class="hero-image-wrap">
        <picture>
          <img src="../images/hero.jpg" alt="Best SEO Company in Beawar — rankfyno organic growth trophy" class="hero-image" loading="eager" width="1280" height="720" />
        </picture>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Rajasthan businesses. We rank Beawar companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
