...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Agency in Banswara — rankfyno Local SEO</title>
  <meta name="description" content="rankfyno is a local SEO agency in Banswara. We engineer GBP, citation, on-page and content SEO for Banswara businesses — artisanal handicrafts · handloom weaving · block prints · local trade checkposts. Real rankings. Real leads." />
  ...
  <header class="hero">
    <div class="container hero-inner">
      <div class="hero-image-wrap">
        <picture>
          <img src="../images/hero.jpg" alt="Best SEO Company in Banswara — rankfyno organic growth trophy" class="hero-image" loading="eager" width="1280" height="720" />
        </picture>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Rajasthan businesses. We rank Banswara companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
