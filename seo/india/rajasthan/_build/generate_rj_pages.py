...
from rj_districts import DISTRICTS, CATEGORIES_COPIES

# HTML template for the 46 district pages
...
<head>
  ...
  <link rel="canonical" href="https://nexus.studio/seo/india/rajasthan/{slug}/" />
  ...
  <meta property="og:url" content="https://nexus.studio/seo/india/rajasthan/{slug}/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/rajasthan/images/hero.jpg" />
  ...
  <meta name="twitter:image" content="https://nexus.studio/seo/india/rajasthan/images/hero.jpg" />
  ...
  {{
    ...
    "itemListElement": [
      ...
      {{ "@type": "ListItem", "position": 3, "name": "Rajasthan", "item": "https://nexus.studio/seo/india/rajasthan/" }},
      {{ "@type": "ListItem", "position": 4, "name": "{name}", "item": "https://nexus.studio/seo/india/rajasthan/{slug}/" }}
    ]
  }}
  </script>
  ...
  <nav class="nav" id="nav">
    <div class="container nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li><a href="../index.html" data-cursor-hover>Rajasthan</a></li>
  ...
  <header class="hero">
    <div class="container hero-inner">
      ...
      <div class="hero-cta">
        ...
        <a href="../index.html" class="btn btn-ghost" data-cursor-hover>All Rajasthan districts</a>
      </div>
    ...
    <div class="container">
      ...
      <div class="services-grid reveal-stagger" style="margin-top: 60px;">
        ...
        <div class="service-card" data-cursor-hover>
          ...
          <p>Top Indian + global directories, NAP-consistent across {name} and Rajasthan state listings.</p>
          <div class="service-tags">
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our local SEO campaigns in {name} and Rajasthan.</p>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Rajasthan businesses. We rank {name} companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
        ...
        <div class="footer-col">
          <h5>{name}</h5>
          <ul>
            <li><a href="../index.html" data-cursor-hover>All Rajasthan districts</a></li>
...
# HTML template for the main Rajasthan Hub page
...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Services Rajasthan — NEXUS | Premium SEO Agency</title>
  <meta name="description" content="NEXUS is a performance-driven SEO agency in Rajasthan. We engineer local, national, and e-commerce SEO for Rajasthan businesses across all 46 districts including Jaipur, Udaipur, Jodhpur, and Kota. Real rankings. Real leads." />
  <meta name="keywords" content="SEO agency Rajasthan, SEO company Rajasthan, Rajasthan SEO services, local SEO Rajasthan, Jaipur SEO, Udaipur SEO, technical SEO, content SEO, NEXUS SEO" />
  <meta name="author" content="NEXUS Studio" />
  <meta name="robots" content="index, follow, max-image-preview:large" />
  <link rel="canonical" href="https://nexus.studio/seo/india/rajasthan/" />

  <!-- SEO: OpenGraph -->
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="NEXUS Studio" />
  <meta property="og:title" content="SEO Services Rajasthan — NEXUS" />
  <meta property="og:description" content="Performance-driven SEO for Rajasthan businesses. Local, national, and e-commerce SEO across all 46 districts." />
  <meta property="og:url" content="https://nexus.studio/seo/india/rajasthan/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/rajasthan/images/hero.jpg" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="675" />
  <meta property="og:image:alt" content="NEXUS SEO Agency Rajasthan — engineering organic growth" />

  <!-- SEO: Twitter -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@nexusstudio" />
  <meta name="twitter:title" content="SEO Services Rajasthan — NEXUS" />
  <meta name="twitter:description" content="Performance-driven SEO for Rajasthan businesses. Local, national, and e-commerce SEO across all 46 districts." />
  <meta name="twitter:image" content="https://nexus.studio/seo/india/rajasthan/images/hero.jpg" />
  ...
  {{
    ...
    "@type": "Service",
    "serviceType": "Search Engine Optimization (SEO)",
    "name": "NEXUS SEO Services in Rajasthan",
    "provider": {{
      "@type": "Organization",
      "name": "NEXUS Studio",
      "url": "https://nexus.studio/"
    ...
    "hasOfferCatalog": {{
      "@type": "OfferCatalog",
      "name": "NEXUS Rajasthan SEO Plans",
      "itemListElement": [
        {{ "@type": "Offer", "name": "Local SEO Rajasthan", "price": "30000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Growth SEO Rajasthan", "price": "65000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Authority SEO Rajasthan", "price": "150000", "priceCurrency": "INR" }}
      ]
    }}
  }}
  </script>
  ...
  {{
    ...
    "mainEntity": [
      {{
        "@type": "Question",
        "name": "How much does SEO cost in Rajasthan?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "NEXUS Rajasthan SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national and e-commerce engagements. All plans are month-to-month with 30 days notice."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Which districts in Rajasthan do you serve?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "We serve all 46 districts of Rajasthan, including major hubs like Jaipur, Udaipur, Jodhpur, Kota, Ajmer, Bikaner, and Bhilwara, as well as tier-2 and tier-3 locations."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Do you do bilingual SEO for Rajasthan?",
        "acceptedAnswer": {{
          "@type": "Answer",
      ...
      {{
        "@type": "Question",
        "name": "How long does SEO take to show results in Rajasthan?",
        "acceptedAnswer": {{
          "@type": "Answer",
...
<body>
    ...
    <div class="container hero-inner">
      <div class="hero-meta">
        <div class="hero-meta-left">
          ...
          <div class="hero-meta-info">IND · 46 districts · 6 languages — 24/7</div>
        </div>
      ...
      <div class="hero-stats reveal-stagger">
        <div class="hero-stat">
          ...
          <div class="hero-stat-label">Rajasthan clients ranked</div>
        </div>
        <div class="hero-stat">
          <div class="hero-stat-num"><span class="count" data-target="46">0</span></div>
    ...
    <div class="container">
      <div class="section-head reveal">
        <div>
          ...
          <h2 class="display">Full-stack SEO,<br/><span class="gradient-text">engineered for Rajasthan.</span></h2>
        </div>
        <p class="lede">Six disciplines, one team. We work as an embedded SEO partner for Rajasthan businesses — technical, content, and authority in lockstep, with measurable outcomes on every brief.</p>
      </div>
      ...
      <div class="services-grid reveal-stagger">
        <div class="service-card" data-cursor-hover>
          ...
          <h3>Local SEO</h3>
          <p>Google Business Profile, citations, NAP consistency, and reviews. Built for RJ's city-level search behaviour — from Jaipur to Udaipur.</p>
          <div class="service-tags">
            <span class="service-tag">GBP</span>
            <span class="service-tag">Citations</span>
  ...
  <section>
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">We don't do vanity metrics. Every engagement is wired to rankings, leads, and revenue — with a creative standard built for Rajasthan's unique economic sectors.</p>
      </div>
      ...
      <div class="stats-wrap">
        <div class="stats-grid reveal-stagger">
          ...
          <div class="stat-card">
            <div class="stat-num"><span class="grad">46</span></div>
        ...
        <div class="why-pillars reveal-stagger">
          <div class="pillar">
            ...
            <div>
              <h4>In-house UP &amp; RJ team</h4>
              <p>No outsourcing. Our SEO specialists, content writers, and developers operate locally in Jaipur. Every line of strategy is produced in-house.</p>
            </div>
          </div>
          <div class="pillar">
          ...
          <div class="pillar">
            ...
            <div>
              ...
              <p>We know the differences between tourist-heavy Jaipur &amp; Udaipur, industrial Bhilwara &amp; Pali, education-focused Kota, and the agricultural and craft zones. We structure campaigns around these differences.</p>
            </div>
          </div>
          <div class="pillar">
            ...
            <div>
              ...
              <p>We have specialized playbooks for Rajasthan's core sectors: Tourism &amp; hospitality, marble &amp; mining, education coaching, and local handicrafts.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="eeat-grid reveal-stagger">
        <div class="eeat-block" data-cursor-hover>
          ...
          <h3>Experience</h3>
          <p>First-hand proof. We've shipped SEO in RJ's hardest categories — tourism, hospitality, coaching, mining — and we publish the results, the dashboards, and the mistakes. Real case studies, not sanitized retrospectives.</p>
          <ul class="eeat-list">
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our SEO services and campaigns in Rajasthan.</p>
      </div>

      <div class="faq-list reveal-stagger" style="margin-top: 60px; max-width: 800px; margin-left: auto; margin-right: auto;">
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How much does SEO cost in Rajasthan?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">NEXUS Rajasthan SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national engagements. All plans are month-to-month with 30 days notice.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Which districts in Rajasthan do you serve?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">We serve all 46 districts of Rajasthan, including major hubs like Jaipur, Udaipur, Jodhpur, Kota, Ajmer, Bikaner, and Bhilwara, as well as tier-2 and tier-3 locations.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Do you do bilingual SEO for Rajasthan?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
        ...
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How long does SEO take to show results in Rajasthan?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
  ...
  <div class="cta-wrap" id="cta">
    <div class="container">
      <div class="reveal" style="text-align: center;">
        <span class="eyebrow"><span class="dot"></span> Ready to rank in Rajasthan?</span>
        <h2 class="display" style="margin-top: 30px;">Let's get your Rajasthan business<br /><span class="gradient-text">on page-1 of Google.</span></h2>
        <p style="margin-top: 20px; max-width: 600px; margin-left: auto; margin-right: auto;">Free 30-minute Rajasthan SEO audit — no obligation, no fluff. Walk away with 3-5 actionable things to fix this week.</p>
        <a href="../../../contact.html" class="cta-mega-btn" data-cursor-hover style="margin-top: 40px; margin-left: auto; margin-right: auto;">
          <span>Start a project</span>
          <span class="arrow-circle">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Rajasthan businesses. We rank companies across Jaipur, Udaipur, Jodhpur, Kota, and 42 more districts on page-1 of Google.</p>
        </div>
        <div class="footer-col">
          <h5>Services</h5>
          <ul>
...
def generate_page(district_tuple):
    ...
    hero_sub = f"Rajasthan local SEO — engineered to rank your business in {name} on Google for high-intent local searches. {cat_copy['tagline']}."
    eyebrow_left = f"{name} · Rajasthan · SEO"
    eyebrow_right = f"/ seo / rajasthan / {slug}"
    ...
    general_faqs = [
        ...
        (
            ...
            f"Yes — we serve all of Rajasthan, Delhi NCR, and pan-North India. The {name}-specific page is a deep-dive for clients in this market; if you're elsewhere, our main NEXUS page covers national service."
        ),
        (
...
def generate_hub_page():
    ...
    with open(dest_path, "w", encoding="utf-8") as f:
        f.write(html_content)
    print(f"Generated Rajasthan Hub page -> {dest_path}")

def main():
    print(f"Starting generator for {len(DISTRICTS)} Rajasthan districts...")
    ...
    generate_hub_page()
    print("All Rajasthan pages generated successfully!")
