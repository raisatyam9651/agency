...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Agency in Jaipur — rankfyno Local SEO</title>
  <meta name="description" content="rankfyno is a local SEO agency in Jaipur. We engineer GBP, citation, on-page and content SEO for Jaipur businesses — modern corporate hubs · tech start-ups · professional consultancies · bpo centers. Real rankings. Real leads." />
  ...
  <header class="hero">
    <div class="container hero-inner">
      <div class="hero-image-wrap">
        <picture>
          <img src="../images/hero.jpg" alt="Best SEO Company in Jaipur — rankfyno organic growth trophy" class="hero-image" loading="eager" width="1280" height="720" />
        </picture>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Rajasthan businesses. We rank Jaipur companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
