...
from tg_districts import DISTRICTS, CATEGORIES_COPIES

# HTML template for the 34 district pages
...
<head>
  ...
  <link rel="canonical" href="https://nexus.studio/seo/india/telangana/{slug}/" />
  ...
  <meta property="og:url" content="https://nexus.studio/seo/india/telangana/{slug}/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/telangana/images/hero.jpg" />
  ...
  <meta name="twitter:image" content="https://nexus.studio/seo/india/telangana/images/hero.jpg" />
  ...
  {{
    ...
    "itemListElement": [
      ...
      {{ "@type": "ListItem", "position": 3, "name": "Telangana", "item": "https://nexus.studio/seo/india/telangana/" }},
      {{ "@type": "ListItem", "position": 4, "name": "{name}", "item": "https://nexus.studio/seo/india/telangana/{slug}/" }}
    ]
  }}
  </script>
  ...
  <nav class="nav" id="nav">
    <div class="container nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li><a href="../index.html" data-cursor-hover>Telangana</a></li>
  ...
  <header class="hero">
    <div class="container hero-inner">
      ...
      <div class="hero-cta">
        ...
        <a href="../index.html" class="btn btn-ghost" data-cursor-hover>All Telangana districts</a>
      </div>
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our local SEO campaigns in {name} and Telangana.</p>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Telangana businesses. We rank {name} companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
        ...
        <div class="footer-col">
          <h5>Telangana</h5>
          <ul>
            <li><a href="../index.html" data-cursor-hover>All Telangana districts</a></li>
...
# HTML template for the main Telangana Hub page
...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Services Telangana — NEXUS | Premium SEO Agency</title>
  <meta name="description" content="NEXUS is a performance-driven SEO agency in Telangana. We engineer local, national, and e-commerce SEO for Telangana businesses across all 34 districts including Hyderabad, Warangal, Karimnagar, and Nizamabad. Real rankings. Real leads." />
  <meta name="keywords" content="SEO agency Telangana, SEO company Telangana, Telangana SEO services, local SEO Telangana, Hyderabad SEO, Warangal SEO, technical SEO, content SEO, NEXUS SEO" />
  <meta name="author" content="NEXUS Studio" />
  <meta name="robots" content="index, follow, max-image-preview:large" />
  <link rel="canonical" href="https://nexus.studio/seo/india/telangana/" />

  <!-- SEO: OpenGraph -->
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="NEXUS Studio" />
  <meta property="og:title" content="SEO Services Telangana — NEXUS" />
  <meta property="og:description" content="Performance-driven SEO for Telangana businesses. Local, national, and e-commerce SEO across all 34 districts." />
  <meta property="og:url" content="https://nexus.studio/seo/india/telangana/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/telangana/images/hero.jpg" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="675" />
  <meta property="og:image:alt" content="NEXUS SEO Agency Telangana — engineering organic growth" />

  <!-- SEO: Twitter -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@nexusstudio" />
  <meta name="twitter:title" content="SEO Services Telangana — NEXUS" />
  <meta name="twitter:description" content="Performance-driven SEO for Telangana businesses. Local, national, and e-commerce SEO across all 34 districts." />
  <meta name="twitter:image" content="https://nexus.studio/seo/india/telangana/images/hero.jpg" />
  ...
  {{
    ...
    "@type": "Service",
    "serviceType": "Search Engine Optimization (SEO)",
    "name": "NEXUS SEO Services in Telangana",
    "provider": {{
      "@type": "Organization",
      "name": "NEXUS Studio",
      "url": "https://nexus.studio/"
    ...
    "hasOfferCatalog": {{
      "@type": "OfferCatalog",
      "name": "NEXUS Telangana SEO Plans",
      "itemListElement": [
        {{ "@type": "Offer", "name": "Local SEO Telangana", "price": "30000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Growth SEO Telangana", "price": "65000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Authority SEO Telangana", "price": "150000", "priceCurrency": "INR" }}
      ]
    }}
  }}
  </script>
  ...
  {{
    ...
    "mainEntity": [
      {{
        "@type": "Question",
        "name": "How much does SEO cost in Telangana?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "NEXUS Telangana SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national and e-commerce engagements. All plans are month-to-month with 30 days notice."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Which districts in Telangana do you serve?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "We serve all 34 districts of Telangana, including major hubs like Hyderabad, Warangal, Karimnagar, Nizamabad, Khammam, and Mahabubnagar, as well as tier-2 and tier-3 locations."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Do you do bilingual SEO for Telangana?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "Yes, we design bilingual (Telugu & English) SEO strategies, optimize for regional Hinglish queries, and use appropriate schema and hreflang configuration to capture the local search intent."
        }}
      }},
      {{
        "@type": "Question",
        "name": "How long does SEO take to show results in Telangana?",
        "acceptedAnswer": {{
          "@type": "Answer",
...
<body>
    ...
    <div class="container hero-inner">
      <div class="hero-meta">
        <div class="hero-meta-left">
          ...
          <div class="hero-meta-info">IND · 34 districts · 6 languages — 24/7</div>
        </div>
      ...
      <h1 class="display">
        <div class="word"><span class="char">S</span><span class="char">E</span><span class="char">O</span></div>
        <div class="word"><span class="char gradient-text">T</span><span class="char gradient-text">e</span><span class="char gradient-text">l</span><span class="char gradient-text">a</span><span class="char gradient-text">n</span><span class="char gradient-text">g</span><span class="char gradient-text">a</span><span class="char gradient-text">n</span><span class="char gradient-text">a</span><span class="char">.</span></div>
      </h1>

      <p class="hero-sub">A performance-driven SEO studio for ambitious Telangana brands. We blend technical SEO, content, and authority engineering to build organic growth that compounds — across all 34 districts of Telangana.</p>
      ...
      <div class="hero-cta">
        ...
        <a href="#locations" class="btn btn-ghost" data-cursor-hover>
          View all 34 districts
        </a>
      </div>

      <div class="hero-stats reveal-stagger">
        <div class="hero-stat">
          <div class="hero-stat-num"><span class="count" data-target="210">0</span><span class="unit">+</span></div>
          <div class="hero-stat-label">Telangana clients ranked</div>
        </div>
        <div class="hero-stat">
          <div class="hero-stat-num"><span class="count" data-target="34">0</span></div>
  ...
  <section id="capabilities">
    <div class="container">
      <div class="section-head reveal">
        <div>
          <span class="eyebrow"><span class="dot"></span> Capabilities</span>
          <h2 class="display">Full-stack SEO,<br/><span class="gradient-text">engineered for Telangana.</span></h2>
        </div>
        <p class="lede">Six disciplines, one team. We work as an embedded SEO partner for Telangana businesses — technical, content, and authority in lockstep, with measurable outcomes on every brief.</p>
      </div>
      ...
      <div class="services-grid reveal-stagger">
        <div class="service-card" data-cursor-hover>
          ...
          <h3>Local SEO</h3>
          <p>Google Business Profile, citations, NAP consistency, and reviews. Built for TG's city-level search behaviour — from Hyderabad to Warangal.</p>
        ...
        <div class="service-card" data-cursor-hover>
          ...
          <p>Rank in English, Telugu, and other regional languages. Hreflang, language-targeted landing pages, and native-speaker content for bilingual queries.</p>
          <div class="service-tags">
            <span class="service-tag">Telugu</span>
  ...
  <section>
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">We don't do vanity metrics. Every engagement is wired to rankings, leads, and revenue — with a creative standard built for Telangana's unique economic sectors.</p>
      </div>

      <div class="stats-wrap">
        <div class="stats-grid reveal-stagger">
          <div class="stat-card">
            <div class="stat-num"><span class="grad">210</span><span class="stat-suffix">+</span></div>
          ...
          <div class="stat-card">
            <div class="stat-num"><span class="grad">34</span></div>
        ...
        <div class="why-pillars reveal-stagger">
          <div class="pillar">
            ...
            <div>
              <h4>In-house UP, MH &amp; TG team</h4>
              <p>No outsourcing. Our SEO specialists, content writers, and developers operate locally in Hyderabad. Every line of strategy is produced in-house.</p>
            </div>
          </div>
          <div class="pillar">
          ...
          <div class="pillar">
            ...
            <div>
              ...
              <p>We know the differences between tech-heavy Hyderabad &amp; Medchal, pharma hubs in Sangareddy, coal mining in Bhadradri, and agricultural cotton belts.</p>
            </div>
          </div>
          <div class="pillar">
            ...
            <div>
              ...
              <p>We have specialized playbooks for Telangana's core sectors: Software startups, bulk pharmaceuticals, coal logistics, and cotton ginning.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="eeat-grid reveal-stagger">
        <div class="eeat-block" data-cursor-hover>
          ...
          <h3>Experience</h3>
          <p>First-hand proof. We've shipped SEO in Telangana's hardest categories — high-volume technology startups in Hyderabad, pharmaceutical manufacturing units in Sangareddy, and coal logistics. Real case studies, not sanitized retrospectives.</p>
          <ul class="eeat-list">
            <li>8 years operating in India · 210+ clients</li>
        ...
        <div class="eeat-block" data-cursor-hover>
          ...
          <p>Transparent, honest, and accountable. No lock-in contracts. No "secret sauce" you can't audit. Month-to-month engagements, full data ownership, and published procedures you can verify.</p>
          <ul class="eeat-list">
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our SEO services and campaigns in Telangana.</p>
      </div>

      <div class="faq-list reveal-stagger" style="margin-top: 60px; max-width: 800px; margin-left: auto; margin-right: auto;">
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How much does SEO cost in Telangana?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">NEXUS Telangana SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national engagements. All plans are month-to-month with 30 days notice.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Which districts in Telangana do you serve?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">We serve all 34 districts of Telangana, including major hubs like Hyderabad, Warangal, Karimnagar, Nizamabad, Khammam, and Mahabubnagar, as well as tier-2 and tier-3 locations.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Do you do bilingual SEO for Telangana?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">Yes, we design bilingual (Telugu &amp; English) SEO strategies, optimize for regional Hinglish queries, and use appropriate schema and hreflang configuration to capture the local search intent.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How long does SEO take to show results in Telangana?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
  ...
  <div class="cta-wrap" id="cta">
    <div class="container">
      <div class="reveal" style="text-align: center;">
        <span class="eyebrow"><span class="dot"></span> Ready to rank in Telangana?</span>
        <h2 class="display" style="margin-top: 30px;">Let's get your Telangana business<br /><span class="gradient-text">on page-1 of Google.</span></h2>
        <p style="margin-top: 20px; max-width: 600px; margin-left: auto; margin-right: auto;">Free 30-minute Telangana SEO audit — no obligation, no fluff. Walk away with 3-5 actionable things to fix this week.</p>
        <a href="../../../contact.html" class="cta-mega-btn" data-cursor-hover style="margin-top: 40px; margin-left: auto; margin-right: auto;">
          <span>Start a project</span>
          <span class="arrow-circle">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>A premium SEO studio for ambitious Telangana brands. Engineering organic growth since 2018 — across all 34 districts.</p>
        </div>
        <div class="footer-col">
          <h5>Capabilities</h5>
          <ul>
        ...
        <div class="footer-col">
          <h5>Telangana</h5>
          <ul>
            <li><a href="#" data-cursor-hover>TG Hub</a></li>
            <li><a href="../index.html" data-cursor-hover>SEO in India</a></li>
            <li><a href="../../../index.html#pricing" data-cursor-hover>Pricing</a></li>
            <li><a href="../../../index.html#process" data-cursor-hover>Process</a></li>
          </ul>
...
def generate_page(district_tuple):
    ...
    hero_sub = f"Telangana local SEO — engineered to rank your business in {name} on Google for high-intent local searches. {cat_copy['tagline']}."
    eyebrow_left = f"{name} · Telangana · SEO"
    eyebrow_right = f"/ seo / telangana / {slug}"
    ...
    general_faqs = [
        ...
        (
            ...
            f"Yes — we serve all of Telangana, Maharashtra, Delhi NCR, and pan-India. The {name}-specific page is a deep-dive for clients in this market."
        ),
        (
            f"Do you handle Google Business Profile for {name} shops?",
            f"Yes. GBP setup, verification, category optimization, weekly Google Posts, and review-response workflows are part of our engagements."
        ),
        (
            f"What does SEO cost in {name}?",
            f"Our {name} retainers start at ₹30,000/month (Local), ₹65,000/month (Growth), and custom for Authority engagements."
        ),
        (
            f"Do you do bilingual SEO for {name}?",
            f"Yes. {name} search behavior is bilingual — we target queries in Telugu & English, using structured markup for both variants."
        )
    ]
...
def generate_hub_page():
    ...
    with open(dest_path, "w", encoding="utf-8") as f:
        f.write(html_content)
    print(f"Generated Telangana Hub page -> {dest_path}")

def main():
    print(f"Starting generator for {len(DISTRICTS)} Telangana districts...")
    ...
    generate_hub_page()
    print("All Telangana pages generated successfully!")
