...
from bh_districts import DISTRICTS, CATEGORIES_COPIES

# HTML template for the 38 district pages
...
<head>
  ...
  <link rel="canonical" href="https://nexus.studio/seo/india/bihar/{slug}/" />
  ...
  <meta property="og:url" content="https://nexus.studio/seo/india/bihar/{slug}/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/bihar/images/hero.jpg" />
  ...
  <meta name="twitter:image" content="https://nexus.studio/seo/india/bihar/images/hero.jpg" />
  ...
  {{
    ...
    "itemListElement": [
      ...
      {{ "@type": "ListItem", "position": 3, "name": "Bihar", "item": "https://nexus.studio/seo/india/bihar/" }},
      {{ "@type": "ListItem", "position": 4, "name": "{name}", "item": "https://nexus.studio/seo/india/bihar/{slug}/" }}
    ]
  }}
  </script>
  ...
  <nav class="nav" id="nav">
    <div class="container nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li><a href="../index.html" data-cursor-hover>Bihar</a></li>
  ...
  <header class="hero">
    <div class="container hero-inner">
      ...
      <div class="hero-cta">
        ...
        <a href="../index.html" class="btn btn-ghost" data-cursor-hover>All Bihar districts</a>
      </div>
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our local SEO campaigns in {name} and Bihar.</p>
      </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Bihar businesses. We rank {name} companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
        ...
        <div class="footer-col">
          <h5>Bihar</h5>
          <ul>
            <li><a href="../index.html" data-cursor-hover>All Bihar districts</a></li>
...
# HTML template for the main Bihar Hub page
...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Services Bihar — NEXUS | Premium SEO Agency</title>
  <meta name="description" content="NEXUS is a performance-driven SEO agency in Bihar. We engineer local, national, and e-commerce SEO for Bihar businesses across all 38 districts including Patna, Gaya, Bhagalpur, and Muzaffarpur. Real rankings. Real leads." />
  <meta name="keywords" content="SEO agency Bihar, SEO company Bihar, Bihar SEO services, local SEO Bihar, Patna SEO, Gaya SEO, technical SEO, content SEO, NEXUS SEO" />
  <meta name="author" content="NEXUS Studio" />
  <meta name="robots" content="index, follow, max-image-preview:large" />
  <link rel="canonical" href="https://nexus.studio/seo/india/bihar/" />

  <!-- SEO: OpenGraph -->
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="NEXUS Studio" />
  <meta property="og:title" content="SEO Services Bihar — NEXUS" />
  <meta property="og:description" content="Performance-driven SEO for Bihar businesses. Local, national, and e-commerce SEO across all 38 districts." />
  <meta property="og:url" content="https://nexus.studio/seo/india/bihar/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/bihar/images/hero.jpg" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="675" />
  <meta property="og:image:alt" content="NEXUS SEO Agency Bihar — engineering organic growth" />

  <!-- SEO: Twitter -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@nexusstudio" />
  <meta name="twitter:title" content="SEO Services Bihar — NEXUS" />
  <meta name="twitter:description" content="Performance-driven SEO for Bihar businesses. Local, national, and e-commerce SEO across all 38 districts." />
  <meta name="twitter:image" content="https://nexus.studio/seo/india/bihar/images/hero.jpg" />
  ...
  {{
    ...
    "@type": "Service",
    "serviceType": "Search Engine Optimization (SEO)",
    "name": "NEXUS SEO Services in Bihar",
    "provider": {{
      "@type": "Organization",
      "name": "NEXUS Studio",
      "url": "https://nexus.studio/"
    ...
    "hasOfferCatalog": {{
      "@type": "OfferCatalog",
      "name": "NEXUS Bihar SEO Plans",
      "itemListElement": [
        {{ "@type": "Offer", "name": "Local SEO Bihar", "price": "30000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Growth SEO Bihar", "price": "65000", "priceCurrency": "INR" }},
        {{ "@type": "Offer", "name": "Authority SEO Bihar", "price": "150000", "priceCurrency": "INR" }}
      ]
    }}
  }}
  </script>
  ...
  {{
    ...
    "mainEntity": [
      {{
        "@type": "Question",
        "name": "How much does SEO cost in Bihar?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "NEXUS Bihar SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national and e-commerce engagements. All plans are month-to-month with 30 days notice."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Which districts in Bihar do you serve?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "We serve all 38 districts of Bihar, including major hubs like Patna, Gaya, Bhagalpur, Muzaffarpur, Darbhanga, and Purnia, as well as tier-2 and tier-3 locations."
        }}
      }},
      {{
        "@type": "Question",
        "name": "Do you do bilingual SEO for Bihar?",
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "Yes, we design bilingual (Hindi & English) SEO strategies, optimize for regional Hinglish and Maithili/Bhojpuri queries, and use appropriate schema and hreflang configuration to capture the local search intent."
        }}
      }},
      {{
        "@type": "Question",
        "name": "How long does SEO take to show results in Bihar?",
        "acceptedAnswer": {{
          "@type": "Answer",
...
<body>
    ...
    <div class="container hero-inner">
      <div class="hero-meta">
        <div class="hero-meta-left">
          ...
          <div class="hero-meta-info">IND · 38 districts · 4 languages — 24/7</div>
        </div>
      ...
      <h1 class="display">
        <div class="word"><span class="char">S</span><span class="char">E</span><span class="char">O</span></div>
        <div class="word"><span class="char gradient-text">B</span><span class="char gradient-text">i</span><span class="char gradient-text">h</span><span class="char gradient-text">a</span><span class="char gradient-text">r</span><span class="char">.</span></div>
      </h1>

      <p class="hero-sub">A performance-driven SEO studio for ambitious Bihar brands. We blend technical SEO, content, and authority engineering to build organic growth that compounds — across all 38 districts of Bihar.</p>
      ...
      <div class="hero-stats reveal-stagger">
        <div class="hero-stat">
          <div class="hero-stat-num"><span class="count" data-target="180">0</span><span class="unit">+</span></div>
          <div class="hero-stat-label">Bihar clients ranked</div>
        </div>
        <div class="hero-stat">
          <div class="hero-stat-num"><span class="count" data-target="38">0</span></div>
  ...
  <div class="marquee" aria-hidden="true">
    <div class="marquee-track">
      ...
      <div class="marquee-item"><strong>Multilingual</strong><span class="sep"></span>Hindi · Maithili · Bhojpuri · English</div>
  ...
  <section id="capabilities">
    <div class="container">
      <div class="section-head reveal">
        <div>
          <span class="eyebrow"><span class="dot"></span> Capabilities</span>
          <h2 class="display">Full-stack SEO,<br/><span class="gradient-text">engineered for Bihar.</span></h2>
        </div>
        <p class="lede">Six disciplines, one team. We work as an embedded SEO partner for Bihar businesses — technical, content, and authority in lockstep, with measurable outcomes on every brief.</p>
      </div>
      ...
      <div class="services-grid reveal-stagger">
        <div class="service-card" data-cursor-hover>
          ...
          <h3>Local SEO</h3>
          <p>Google Business Profile, citations, NAP consistency, and reviews. Built for Bihar's city-level search behaviour — from Patna to Bhagalpur.</p>
        ...
        <div class="service-card" data-cursor-hover>
          ...
          <p>Rank in English, Hindi, Maithili, and Bhojpuri. Hreflang, language-targeted landing pages, and native-speaker content for bilingual queries.</p>
          <div class="service-tags">
            <span class="service-tag">Hindi</span>
            <span class="service-tag">Maithili</span>
  ...
  <section>
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">We don't do vanity metrics. Every engagement is wired to rankings, leads, and revenue — with a creative standard built for Bihar's unique economic sectors.</p>
      </div>

      <div class="stats-wrap">
        <div class="stats-grid reveal-stagger">
          <div class="stat-card">
            <div class="stat-num"><span class="grad">180</span><span class="stat-suffix">+</span></div>
          ...
          <div class="stat-card">
            <div class="stat-num"><span class="grad">38</span></div>
        ...
        <div class="why-pillars reveal-stagger">
          <div class="pillar">
            ...
            <div>
              <h4>In-house Bihar &amp; eastern India team</h4>
              <p>No outsourcing. Our SEO specialists, content writers, and developers operate with deep understanding of Bihar's markets. Every line of strategy is produced in-house.</p>
            </div>
          </div>
          <div class="pillar">
            ...
            <div>
              ...
              <p>Bihar buyers search using voice and bilingual queries. We build parallel content structure, schema, and Google Business Profiles for Hindi, Maithili, and Bhojpuri searches.</p>
            </div>
          </div>
          <div class="pillar">
            ...
            <div>
              ...
              <p>We know the differences between coaching-hub Patna, silk-trading Bhagalpur, pilgrimage-driven Gaya, and agri-mandi corridors of Purnia.</p>
            </div>
          </div>
          <div class="pillar">
            ...
            <div>
              ...
              <p>We have specialized playbooks for Bihar's core sectors: coaching institutes, food processing, pilgrimage tourism, Madhubani art trade, and agricultural mandis.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="eeat-grid reveal-stagger">
        <div class="eeat-block" data-cursor-hover>
          ...
          <h3>Experience</h3>
          <p>First-hand proof. We've shipped SEO in Bihar's hardest categories — coaching institutes, pilgrimage tourism, and agri-trade mandis. Real case studies, not sanitized retrospectives.</p>
          <ul class="eeat-list">
            <li>8 years operating in India · 180+ clients</li>
        ...
        <div class="eeat-block" data-cursor-hover>
          <div class="eeat-letter">E</div>
          <h3>Expertise</h3>
          <p>Senior specialists, not junior generalists. Our strategists have 6–12 years of Indian SEO experience, native-speaker content writers in 4 languages, and developers who can ship schema, hreflang, and Core Web Vitals fixes in-house.</p>
          <ul class="eeat-list">
            <li>Senior strategists on every brief</li>
            <li>Native-speaker content in 4 Indian languages</li>
  ...
  <section id="faq" style="padding: 80px 0; border-top: 1px solid var(--border);">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p class="lede">Answers to standard questions about our SEO services and campaigns in Bihar.</p>
      </div>

      <div class="faq-list reveal-stagger" style="margin-top: 60px; max-width: 800px; margin-left: auto; margin-right: auto;">
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How much does SEO cost in Bihar?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">NEXUS Bihar SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national engagements. All plans are month-to-month with 30 days notice.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Which districts in Bihar do you serve?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">We serve all 38 districts of Bihar, including major hubs like Patna, Gaya, Bhagalpur, Muzaffarpur, Darbhanga, and Purnia, as well as tier-2 and tier-3 locations.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            Do you do bilingual SEO for Bihar?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
            <div class="faq-a-inner">Yes, we design bilingual (Hindi/Maithili &amp; English) SEO strategies, optimize for regional Hinglish queries, and use appropriate schema and hreflang configuration to capture the local search intent.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
            How long does SEO take to show results in Bihar?
            <span class="icon"></span>
          </button>
          <div class="faq-a">
  ...
  <div class="cta-wrap" id="cta">
    <div class="container">
      <div class="reveal" style="text-align: center;">
        <span class="eyebrow"><span class="dot"></span> Ready to rank in Bihar?</span>
        <h2 class="display" style="margin-top: 30px;">Let's get your Bihar business<br /><span class="gradient-text">on page-1 of Google.</span></h2>
        <p style="margin-top: 20px; max-width: 600px; margin-left: auto; margin-right: auto;">Free 30-minute Bihar SEO audit — no obligation, no fluff. Walk away with 3-5 actionable things to fix this week.</p>
        <a href="../../../contact.html" class="cta-mega-btn" data-cursor-hover style="margin-top: 40px; margin-left: auto; margin-right: auto;">
          <span>Start a project</span>
          <span class="arrow-circle">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>A premium SEO studio for ambitious Bihar brands. Engineering organic growth since 2018 — across all 38 districts.</p>
        </div>
        <div class="footer-col">
          <h5>Capabilities</h5>
          <ul>
...
def generate_page(district_tuple):
    ...
    hero_sub = f"Bihar local SEO — engineered to rank your business in {name} on Google for high-intent local searches. {cat_copy['tagline']}."
    eyebrow_left = f"{name} · Bihar · SEO"
    eyebrow_right = f"/ seo / bihar / {slug}"
    ...
    general_faqs = [
        ...
        (
            ...
            f"Yes — we serve all of Bihar, Jharkhand, UP, and pan-India. The {name}-specific page is a deep-dive for clients in this market."
        ),
        (
        ...
        (
            ...
            f"Yes. {name} search behavior is bilingual — we target queries in Hindi/Maithili & English, using structured markup for both variants."
        )
    ]
...
def generate_hub_page():
    ...
    with open(dest_path, "w", encoding="utf-8") as f:
        f.write(html_content)
    print(f"Generated Bihar Hub page -> {dest_path}")

def main():
    print(f"Starting generator for {len(DISTRICTS)} Bihar districts...")
    ...
    generate_hub_page()
    print("All Bihar pages generated successfully!")
