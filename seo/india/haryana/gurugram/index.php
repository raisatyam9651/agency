...
<head>
  ...
  <!-- SEO: Primary meta -->
  <title>SEO Agency in Gurugram — rankfyno Local SEO</title>
  <meta name="description" content="rankfyno is a local SEO agency in Gurugram. We rank corporate, SaaS, fintech, real estate, and premium service brands on Google — with DLF-Phase-level precision and the SERP intelligence that wins tier-1 markets." />
  ...
  <header class="hero">
    <div class="container hero-inner">
      <div class="hero-image-wrap">
        <picture>
          <img src="../images/hero.jpg" alt="Best SEO Company in Gurugram — rankfyno organic growth trophy" class="hero-image" loading="eager" width="1280" height="720" />
        </picture>
      </div>
    ...
    <div class="container">
      <div class="section-head reveal">
        <div>
          ...
          <h2 class="display">Plans for <span class="gradient-text">Gurugram.</span></h2>
        </div>
      ...
      <div class="pricing-grid reveal-stagger" style="margin-top: 60px;">
        <div class="price-card" data-tilt data-cursor-hover>
          ...
          <p class="price-desc">For single-location Gurugram businesses ready to dominate tier-1 local search.</p>
        ...
        <div class="price-card featured" data-tilt data-cursor-hover>
          ...
          <p class="price-desc">For Gurugram businesses expanding across Delhi-NCR and capturing SaaS/fintech intent.</p>
          <div class="price-features">
            <div class="price-feature">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
        ...
        <div class="price-card" data-tilt data-cursor-hover>
          ...
          <p class="price-desc">For Gurugram enterprises, builders, and B2B brands going pan-India.</p>
          <div class="price-features">
            <div class="price-feature">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>Local SEO engineered for Haryana businesses. We rank Gurugram companies on page-1 of Google — measurably, predictably, and at a price that pays for itself.</p>
        </div>
