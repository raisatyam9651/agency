"""Generator for agency/seo/india/index.html national hub page."""
import os

def generate_india_hub():
    ...
    # Generate list items for locations grid
    li_items = []
    for slug, name in states:
        li_items.append(f'          <li class="location-link-item" data-cursor-hover><a href="{slug}/index.html">SEO Agency in {name}</a></li>')
    columns_links_html = "\n".join(li_items)
    
    # Generate footer links
    footer_li = []
    for slug, name in states:
        footer_li.append(f'            <li><a href="{slug}/index.html" data-cursor-hover>SEO in {name}</a></li>')
    footer_links_html = "\n".join(footer_li)
...
<head>
  ...
  <link rel="canonical" href="https://nexus.studio/seo/india/" />

  <!-- SEO: OpenGraph -->
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="NEXUS Studio" />
  <meta property="og:title" content="SEO Agency in India — NEXUS" />
  ...
  <meta property="og:url" content="https://nexus.studio/seo/india/" />
  <meta property="og:locale" content="en_IN" />
  <meta property="og:image" content="https://nexus.studio/seo/india/images/hero.jpg" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="675" />
  <meta property="og:image:alt" content="NEXUS SEO Agency India — engineering organic growth" />

  <!-- SEO: Twitter -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@nexusstudio" />
  <meta name="twitter:title" content="SEO Agency in India — NEXUS" />
  ...
  <meta name="twitter:image" content="https://nexus.studio/seo/india/images/hero.jpg" />
  ...
  {{
    ...
    "name": "NEXUS SEO Services in India",
    "provider": {{
      "@type": "Organization",
      "name": "NEXUS Studio",
      "url": "https://nexus.studio/"
  ...
  {{
    ...
    "mainEntity": [
      {{
        ...
        "acceptedAnswer": {{
          "@type": "Answer",
          "text": "NEXUS India SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national and e-commerce engagements. All plans are month-to-month with 30 days notice."
        }}
      }},
      {{
        "@type": "Question",
  ...
  <nav class="nav" id="nav">
    <div class="container nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li><a href="../../index.html" data-cursor-hover>Home</a></li>
    ...
    <div class="container">
      ...
      <div class="faq-list reveal-stagger" style="margin-top: 60px; max-width: 800px; margin-left: auto; margin-right: auto;">
        <div class="faq-item">
          ...
          <div class="faq-a">
            <div class="faq-a-inner">NEXUS India SEO retainers start at ₹30,000/month for Local SEO, ₹65,000/month for Growth, and custom pricing for national and e-commerce engagements. All plans are month-to-month with 30 days notice.</div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-q" data-cursor-hover>
...
"""
    with open(out_file, "w", encoding="utf-8") as f:
        f.write(html)
    print("Generated India Hub index.html successfully!")
